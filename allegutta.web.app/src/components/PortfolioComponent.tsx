      ...
      <table className="table table-striped table-hover" aria-labelledby="tableLabel" id="portfolio-positions-table">
        <thead className=''>
          <tr style={{ cursor: "pointer" }}>
            ...
            <th className='d-none d-md-table-cell text-end text-nowrap' onClick={e => this.sortClick(e, "currentValue")}>
              Verdi
              <span className="ms-1" style={{ display: "inline-block" }}>
            ...
            <th className='d-none d-lg-table-cell text-end text-nowrap' onClick={e => this.sortClick(e, "returnValue")}>
        ...
        <tfoot>
          <tr>
            ...
            <th className={'d-none d-lg-table-cell text-end ' + (this._dataSummary["returnValue"] >= 0 ? "text-success" : "text-danger")}>
